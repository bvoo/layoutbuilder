...
export const registerPresetCollection = (collection: ComponentPresetCollection) => {
...
export const getOptionsForTool = (tool: ComponentToolId): ComponentPresetOption[] =>
  getCollectionForTool(tool)?.options ?? []

export const getDefaultPresetId = (tool: ComponentToolId): string | null =>
  getCollectionForTool(tool)?.defaultSelection ?? null

export type { ComponentPresetCollection, ComponentPresetOption, ComponentToolId }
