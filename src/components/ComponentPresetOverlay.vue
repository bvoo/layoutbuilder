...
const isComponentDropperActive = computed(() => componentTools.value.includes(activeTool.value as string))
...
<template>
  ...
  >
    ...
    <Select :model-value="activeSelection" placeholder="Select preset" @update:model-value="handlePresetChange">
      <SelectTrigger size="sm" class="w-60 text-left normal-case tracking-normal">
